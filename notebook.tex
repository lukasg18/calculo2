...
{\color{incolor}In [{\color{incolor}84}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}147}]:} \PY{k}{def} \PY{n+nf}{gera\PYZus{}grafico}\PY{p}{(}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}148}]:} \PY{n}{gera\PYZus{}grafico}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\section{verificar os valores da derivada nos
...
\end{equation*}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}131}]:} \PY{k}{def} \PY{n+nf}{fatorial}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
          ...
          \PY{k}{def} \PY{n+nf}{verifica\PYZus{}derivada}\PY{p}{(}\PY{p}{)}\PY{p}{:}
              ...
              \PY{k}{for} \PY{n}{p} \PY{o+ow}{in} \PY{n}{pontos}\PY{p}{:}
                  \PY{n}{v} \PY{o}{=} \PY{n}{valores}\PY{p}{[}\PY{n}{i}\PY{p}{]}
                  \PY{n}{resultado} \PY{o}{=} \PY{l+m+mf}{0.0}
                  \PY{k}{for} \PY{n}{n} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{20}\PY{p}{)}\PY{p}{:}
                      \PY{n}{fat} \PY{o}{=} \PY{n}{fatorial}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{n}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
                      \PY{k}{if} \PY{n}{p} \PY{o}{==} \PY{l+m+mf}{0.0}\PY{p}{:}
                          \PY{n}{resultado} \PY{o}{=} \PY{l+m+mi}{1}
                      \PY{k}{else}\PY{p}{:}
                          \PY{n}{resultado} \PY{o}{=} \PY{n}{resultado} \PY{o}{+} \PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)} \PY{o}{*}\PY{o}{*} \PY{n}{n}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{n}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n}{fat}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{p}{(}\PY{n}{p}\PY{p}{)} \PY{o}{*}\PY{o}{*} \PY{p}{(}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{n}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
                  \PY{n}{tabela}\PY{o}{.}\PY{n}{add\PYZus{}row}\PY{p}{(}\PY{p}{[}\PY{n}{v}\PY{p}{,}\PY{n}{resultado}\PY{p}{]}\PY{p}{)}
                  \PY{n}{i}\PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
              \PY{n+nb}{print}\PY{p}{(}\PY{n}{tabela}\PY{o}{.}\PY{n}{draw}\PY{p}{(}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}132}]:} \PY{n}{verifica\PYZus{}derivada}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
